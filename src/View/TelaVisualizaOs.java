 ...
 * @author Alvaro
 */
public class TelaVisualizaOs extends javax.swing.JFrame {

    /**
     * Creates new form TelaVisualizaOs
     */
    public TelaVisualizaOs() throws SQLException {
        initComponents();
        AjustaTabela();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TelaVisualizaOs.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizaOs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
